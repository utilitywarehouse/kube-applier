...
func (_m *MockClientInterface) Apply(path string, dryRun bool) (string, string, error) {
	ret := _m.ctrl.Call(_m, "Apply", path, dryRun)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
func (_mr *_MockClientInterfaceRecorder) Apply(arg0, arg1 interface{}) *gomock.Call {
