...
import (
	...
	kube "github.com/utilitywarehouse/kube-applier/kube"
	reflect "reflect"
)
...
func (m *MockClientInterface) GetNamespaceStatus(namespace string) (kube.AutomaticDeploymentOption, error) {
	ret := m.ctrl.Call(m, "GetNamespaceStatus", namespace)
	ret0, _ := ret[0].(kube.AutomaticDeploymentOption)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
